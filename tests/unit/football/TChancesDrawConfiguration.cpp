...
void TChancesDrawConfiguration::TestExceptions() const
{
	...
	CheckException( []()
	{
		CChancesDrawConfiguration{ CChancesDrawConfiguration::DEFAULT_AVERAGE_CHANCES, -1 };
	},
		"The average number of corner kicks cannot be negative." );
	CheckException( []()
	{
		CChancesDrawConfiguration{ CChancesDrawConfiguration::DEFAULT_AVERAGE_CHANCES, CChancesDrawConfiguration::DEFAULT_AVERAGE_CORNER_KICKS, -1 };
	},
		"The average number of 1 on 1 vs GK chances cannot be negative." );
	CheckException( []()
	{
		CChancesDrawConfiguration{ CChancesDrawConfiguration::DEFAULT_AVERAGE_CHANCES, CChancesDrawConfiguration::DEFAULT_AVERAGE_CORNER_KICKS,
