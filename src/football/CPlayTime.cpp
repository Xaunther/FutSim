...
CPlayTime::CPlayTime( const json& aJSON ) try :
	futsim::CPlayTime( ValueFromOptionalJSONKey<period_count>( aJSON, PERIOD_COUNT_KEY, default_traits<CPlayTime>::PERIOD_COUNT ),
		ValueFromOptionalJSONKey<period_time>( aJSON, PERIOD_TIME_KEY, default_traits<CPlayTime>::PERIOD_TIME ) ),
